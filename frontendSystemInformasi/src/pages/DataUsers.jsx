    ...
    <div className="flex flex-col min-h-screen">
      <div className="flex flex-grow">
        ...
        <div className="relative pb-8 overflow-x-auto shadow-md sm:rounded-lg w-full lg:w-9/12 md:m-10">
          ...
          <div className="flex items-center justify-between bg-white mt-[20vh] px-4 z-[5] w-11/12 md:mx-4 rounded-t">
              ...
              <div className="relative mt-1">
                ...
                >
                  <input
                    type="text"
                    id="table-search"
                    className="block py-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg lg:w-80 w-60 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Search for items"
                  />

                  <button
                    type="submit"
                    class="flex min-w-full lg:max-w-[3rem] lg:min-w-[3rem] p-2 justify-center items-center md:ms-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                  >
                    <svg
          ...
          <div className="overflow-x-auto w-11/12 mx-4">
            <table className="text-sm text-left m-0 rounded-none rtl:text-right text-gray-500 dark:text-gray-400 border-t w-full">
