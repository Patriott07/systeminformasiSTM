      ...
      >
        <div className="h-full px-3 py-12 overflow-y-auto">
          ...
          <ul className="space-y-2 font-medium text-sm">
            <li>
              <Link to="/dashboard/home" className={`flex items-center p-2 rounded-lg gap-2 ${isActive('/dashboard/home') ? 'bg-blue-500 text-white' : 'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700'}`}>
            ...
            <li>
              <Link to="/dashboard/users" className={`flex items-center p-2 rounded-lg gap-2 ${isActive('/dashboard/users') ? 'bg-blue-500 text-white' : 'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700'}`}>
            ...
            <li>
              <Link to="/data_blog" className={`flex items-center p-2 rounded-lg gap-2 ${isActive('/data_blog') ? 'bg-blue-500 text-white' : 'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700'}`}>
            ...
            <li>
              <Link to="/data_kegiatan" className={`flex items-center p-2 rounded-lg gap-2 ${isActive('/data_kegiatan') ? 'bg-blue-500 text-white' : 'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700'}`}>
            ...
            <li>
              <Link to="/data_jurusan" className={`flex items-center p-2 rounded-lg gap-2 ${isActive('/data_jurusan') ? 'bg-blue-500 text-white' : 'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700'}`}>
            ...
            <li>
              <Link to="/data_kurikulum" className={`flex items-center p-2 rounded-lg gap-2 ${isActive('/data_kurikulum') ? 'bg-blue-500 text-white' : 'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700'}`}>
            ...
            <li>
              <Link to="/data_mapel" className={`flex items-center p-2 rounded-lg gap-2 ${isActive('/data_mapel') ? 'bg-blue-500 text-white' : 'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700'}`}>
            ...
            <li>
              <Link to="/data_tags" className={`flex items-center p-2 rounded-lg gap-2 ${isActive('/data_tags') ? 'bg-blue-500 text-white' : 'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700'}`}>
